...
from models.models import D_step, G_step, get_discriminator, get_generator, get_optimizer
...
def train(args):
    ...
    #Batch Sampler
    ImageGen = BatchGen(args.A_src, args.B_src, (H, W))
    ...
    while (True):
        ...
        # Train Discriminator
        A_samples = ImageGen.get_A_samples(batch_size//2, (64,64))
        B_samples = ImageGen.get_B_samples(batch_size//2, (64,64))
        ...
        # Train Generator
        A_samples = ImageGen.get_A_samples(batch_size, (64,64))
        B_samples = ImageGen.get_B_samples(batch_size, (64,64))

        g_A_loss = G_step(G_A, G_B, D_A, optimizer_A, B_samples)
        g_B_loss = G_step(G_B, G_A, D_B, optimizer_B, A_samples)
        ...
        if iterations%int(args.log_iter)==0:
            ...
            A_samples = ImageGen.get_A_samples(3)
            B_samples = ImageGen.get_B_samples(3)
